...
panel.add(buttons[i]);
		...
		JOptionPane.showMessageDialog(null, "Find the hidden button. You have a second to see the button that says ME. Find it as quick as possible and press on it! Have fun and good luck!!! :)");
